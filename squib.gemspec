...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'cairo',                 '1.15.8'
  spec.add_runtime_dependency 'gio2',                  '3.1.4'
  spec.add_runtime_dependency 'gobject-introspection', '3.1.4'
  spec.add_runtime_dependency 'mercenary',             '~> 0.3.4'
  spec.add_runtime_dependency 'nokogiri',              '~> 1.7.2'
  spec.add_runtime_dependency 'pango',                 '3.1.4'
