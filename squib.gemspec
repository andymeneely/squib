...
Gem::Specification.new do |spec|
  ...
  spec.require_paths = ['lib']
    ...
    spec.add_runtime_dependency 'gio2',                  '3.1.6'
    spec.add_runtime_dependency 'gobject-introspection', '3.1.6'
    spec.add_runtime_dependency 'mercenary',             '0.3.6'
    spec.add_runtime_dependency 'nokogiri',              '1.8.0'
    spec.add_runtime_dependency 'pango',                 '3.1.6'
    spec.add_runtime_dependency 'rsvg2',                 '3.1.6'
